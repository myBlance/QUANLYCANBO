...
namespace QLCB
{
    public partial class frmDieuChuyen : DevExpress.XtraEditors.XtraForm
    {
        ...
        void loadDonViDen()
        {
            cboDonViDen.DataSource = _donvi.getList();
            cboDonViDen.DisplayMember = "TENPHONG";
            cboDonViDen.ValueMember = "MAPHONG";    
        }
        ...
        private void btnXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                _dc.Delete(_soQD, 1);
                tb_DIEUCHUYEN dc = _dc.getItem(_soQD);
                var cb = _canbo.getItem(dc.MACB.Value);
                cb.MAPHONG = dc.MAPHONG;
                _canbo.Update(cb);
                loadData();
            }
        }
        ...
        void SaveData()
        {
            ...
            if (_them)
            {
                ...
                dc.MAPHONG = _canbo.getItem(int.Parse(slkCanBo.EditValue.ToString())).MAPHONG;
                dc.MAPHONG2 = int.Parse(cboDonViDen.SelectedValue.ToString());
                dc.CREATED_BY = 1;
        ...
        private void gvDanhSach_Click(object sender, EventArgs e)
        {
            if (gvDanhSach.RowCount > 0)
            {
                ...
                cboDonViDen.SelectedValue = dc.MAPHONG2;
            }
        }
