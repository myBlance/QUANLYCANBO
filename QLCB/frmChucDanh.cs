...
namespace QLCB
{
    public partial class frmChucDanh : DevExpress.XtraEditors.XtraForm
    {
        ...
        void loadData()
        {
            gcDanhSach.DataSource = _chucdanh.getList();
        ...
        void SaveData()
        {
            if (_them)
            {
                tb_CHUCDANH td = new tb_CHUCDANH();
                td.TENCHUCDANH = txtTen.Text;
                _chucdanh.Add(td);
            }
            else
            {
                var td = _chucdanh.getItem(_id);
                td.TENCHUCDANH = txtTen.Text;
                _chucdanh.Update(td);
            }
        }
        private void gvDanhSach_Click(object sender, EventArgs e)
        {
            ...
            {
                _id = int.Parse(gvDanhSach.GetFocusedRowCellValue("MACD").ToString());
                txtTen.Text = gvDanhSach.GetFocusedRowCellValue("TENCHUCDANH").ToString();
            }
        }
